...
## ARTICLE VIII: Project Execution & Tracking

**MANDATORY RULE:**
Whenever a new conversation starts, the AI MUST determine the current sprint and phase exclusively from the "Current Project Status" section instead of asking the user.

If the status indicates "Waiting for implementation", the AI must wait for the phase prompt.

If the phase is marked "Completed", it must continue automatically to Enterprise Verification or the next phase.

# KIYAN Factory ERP Roadmap
...
Sprint 10
Inventory Final Enterprise Integration
